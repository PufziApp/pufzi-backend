...
public class CreateBusinessRequestTests
{
    [Fact]
    ...
    public void EmptyName_ShouldFailValidation()
    {
        ...
        AssertInvalid(
            request,
            nameof(CreateBusinessRequest.Name));
    }
    ...
    public void DescriptionLongerThan2000Characters_ShouldFailValidation()
    {
        ...
        AssertInvalid(
            request,
            nameof(CreateBusinessRequest.Description));
    }
    ...
    public void PhoneNumberLongerThan30Characters_ShouldFailValidation()
    {
        ...
        AssertInvalid(
            request,
            nameof(CreateBusinessRequest.PhoneNumber));
    }
        ...
        string email)
    {
        ...
        AssertInvalid(
            request,
            nameof(CreateBusinessRequest.ContactEmail));
    }
        ...
        string value)
    {
        ...
        AssertInvalid(
            request,
            nameof(CreateBusinessRequest.Latitude));
    }
        ...
        string value)
    {
        ...
        AssertInvalid(
            request,
            nameof(CreateBusinessRequest.Longitude));
    }
    ...
    public void InvalidInstagramUrl_ShouldFailValidation()
    {
        ...
        AssertInvalid(
            request,
            nameof(CreateBusinessRequest.InstagramUrl));
    }
    ...
    public void InvalidFacebookUrl_ShouldFailValidation()
    {
        ...
        AssertInvalid(
            request,
            nameof(CreateBusinessRequest.FacebookUrl));
    }
    ...
    private static CreateBusinessRequest CreateValidRequest(
